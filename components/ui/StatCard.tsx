...
export const StatCard: React.FC<{ stat: StatItem }> = ({ stat }) => {
  ...
  return (
    <div
      className="bg-white border border-slate-200 hover:border-slate-300 transition-all group cursor-default shadow-sm hover:shadow-md flex flex-col justify-between"
      style={{ padding: 'var(--ui-padding, 1.25rem)', borderRadius: 'var(--ui-radius, 0.75rem)' }}
    >
